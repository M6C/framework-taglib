 ...
 */
public class TagIfNotDefine extends TagSupport {

  private String name = null;
  private String scope = null;
  private String checkNotEmpty = null;

  public TagIfNotDefine() {
  }
  ...
  public int doStartTag() {
    ...
    return (value==null) || ("true".equalsIgnoreCase(checkNotEmpty) && UtilString.isEmpty(value.toString())) ? EVAL_BODY_INCLUDE : SKIP_BODY;
  }
