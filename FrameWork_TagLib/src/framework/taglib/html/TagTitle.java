 ...
 */
public class TagTitle extends BodyTagSupport {

  public static final String CONST_TYPE="TITLE";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagTitle");
