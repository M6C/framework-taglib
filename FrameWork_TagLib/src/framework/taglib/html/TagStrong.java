 ...
 */
public class TagStrong extends BodyTagSupport {

  public static final String CONST_TYPE="STRONG";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toHtml() {
    StringBuffer ret = new StringBuffer("<STRONG");
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagStrong");
