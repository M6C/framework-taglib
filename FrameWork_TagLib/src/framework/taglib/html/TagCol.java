 ...
 */
public class TagCol extends TagSupport {

  public static final String CONST_TYPE="COL";
...
public void setAttrClass(String attrClass) {
  ...
  public String toHtml() {
    StringBuffer ret = new StringBuffer("<COL");
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagCol");
