 ...
 */
public class TagNoscript extends TagSupport {

  public static final String CONST_TYPE="NOSCRIPT";
...
public void setAttrEndtag(String attrEndtag) {
  ...
  public String toHtml() {
    StringBuffer ret = new StringBuffer("<NOSCRIPT");
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagNoscript");
