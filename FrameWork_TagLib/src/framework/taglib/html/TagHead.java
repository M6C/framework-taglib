 ...
 */
public class TagHead extends BodyTagSupport {

  public static final String CONST_TYPE="HEAD";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagHead");
