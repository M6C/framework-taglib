 ...
 */
public class TagTh extends BodyTagSupport {

  public static final String CONST_TYPE="TH";
...
public void setAttrClass(String attrClass) {
  ...
  public String toHtml() {
    StringBuffer ret = new StringBuffer("<TH");
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagTh");
