 ...
 */
public class TagScript extends BodyTagSupport {

  public static final String CONST_TYPE="SCRIPT";
...
public void setAttrLanguage(String attrLanguage) {
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagScript");
