 ...
 */
public class TagHtml extends BodyTagSupport {

  public static final String CONST_TYPE="HTML";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagHtml");
