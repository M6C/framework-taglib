 ...
 */
public class TagLi extends BodyTagSupport {

  public static final String CONST_TYPE="LI";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toHtml() {
    StringBuffer ret = new StringBuffer("<LI");
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagLi");
