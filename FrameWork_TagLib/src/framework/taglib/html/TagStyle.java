 ...
 */
public class TagStyle extends BodyTagSupport {

  public static final String CONST_TYPE="STYLE";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagStyle");
