 ...
 */
public class TagNobr extends BodyTagSupport {

  public static final String CONST_TYPE="NOBR";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toHtml() {
    StringBuffer ret = new StringBuffer("<NOBR");
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagNobr");
