 ...
 */
public class TagCenter extends BodyTagSupport {

  public static final String CONST_TYPE="CENTER";
...
public void setAttrStringCharactere(String attrStringCharactere) {
  ...
  public String toJsp() {
    StringBuffer ret = new StringBuffer("<html:TagCenter");
